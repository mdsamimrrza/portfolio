export const portfolioContent = {
  seo: {
    title: "Md Samim Reza | Associate Software Engineer",
    description:
      "Portfolio of Md Samim Reza, Associate Software Engineer at Canada Life specializing in enterprise backend development, Spring Boot, .NET, React, SQL, and full-stack software products.",
    keywords: [
      "Md Samim Reza",
      "Software Engineer",
      "Canada Life",
    ...
    openGraphTitle: "Md Samim Reza | Associate Software Engineer",
    openGraphDescription:
      "Md Samim Reza builds enterprise backend architectures, scalable APIs, and modern full-stack web applications.",
  },
  brand: {
    logoText: "REZADev",
    name: "Md Samim Reza",
    shortBio:
      "Associate Software Engineer at Canada Life, crafting reliable enterprise backend systems, modern web products, and high-performance software architectures.",
  },
  navigation: [
    { name: "Home", href: "/" },
  ...
  hero: {
    eyebrow: "Enterprise systems, full-stack architectures, and high-impact engineering",
    heading: "Md Samim Reza",
    roles: ["Associate Software Engineer", "Full Stack Developer", "Spring Boot Developer", ".NET Developer"],
    description:
      "Graduated in Computer Science and Engineering from Siddaganga Institute of Technology. Currently working full-time as an Associate Software Engineer at Canada Life in a hybrid role.",
    primaryCta: {
      label: "View My Work",
      href: "#projects",
    },
    ...
    items: [
      {
        ...
        description:
          "Joined Canada Life as a full-time Associate Software Engineer in a hybrid role, building production software with a focus on reliable engineering and collaboration.",
        type: "work",
      ...
      },
      {
        ...
        description:
          "Worked on AI-driven systems focused on intelligent query processing and article retrieval, including a query-based article search agent that improves result relevance. Also coordinated workflows across development stages and gained hands-on backend and API experience.",
        type: "work",
      ...
      },
      {
        ...
        description:
          "Completed Computer Science and Engineering studies in May 2026, supporting work across software development, backend systems, and web applications.",
        type: "education",
